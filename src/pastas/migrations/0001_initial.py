    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(help_text='Nombre descriptivo', max_length=200, verbose_name='Nombre')),
                ('numero_documento', models.BigIntegerField(help_text='numero de documento / CUIT', null=True, verbose_name='numero documento')),
                ('direccion', models.CharField(blank=True, help_text='dirección del cliente', max_length=200, null=True, verbose_name='dirección')),
                ('celular', models.BigIntegerField(blank=True, help_text='Número de celular con característica del/la administrador/a', null=True, verbose_name='Celular')),
                ...
                ('user', models.ForeignKey(blank=True, help_text='Usuario con el que se loguea al sistema', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s', related_query_name='%(app_label)s_%(class)s', to=settings.AUTH_USER_MODEL, verbose_name='usuario')),
                ('localidad', models.ForeignKey(blank=True, help_text='localidad donde reside el cliente', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_related', to='pastas.localidad', verbose_name='localidad')),
                ('provincia', models.ForeignKey(blank=True, help_text='provincia donde reside', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_related', to='pastas.provincia', verbose_name='provincia')),
            ],
        ),
        migrations.CreateModel(
            name='Receta',
